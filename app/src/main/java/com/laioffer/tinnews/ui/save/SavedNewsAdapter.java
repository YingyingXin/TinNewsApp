...
public class SavedNewsAdapter extends RecyclerView.Adapter<SavedNewsAdapter.SavedNewViewHolder> {
   interface ItemCallback{
       //此处定义方法，在saveFragment里implement
   ...
   private ItemCallback itemCallback;
    ...
    @NonNull
    @Override
    public SavedNewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.saved_news_item, parent, false);
        return new SavedNewViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull SavedNewViewHolder holder, int position) {
    ...
    public static class SavedNewViewHolder extends RecyclerView.ViewHolder {
        TextView authorTextView;
        TextView descriptionTextView;
        ImageView favoriteIcon;
        public SavedNewViewHolder(@NonNull View itemView) {
            super(itemView);
